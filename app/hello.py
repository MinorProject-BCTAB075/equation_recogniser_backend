...
modelI = keras.models.load_model('./app/model/model.keras')
...
def get_parts_from_image(image_path):
    ...
    if img is not None:
        ...
        for r in final_rect:
            ...
            h = r[3]
            x2, y2 = x + r[2], y + r[3]
            if global_bounding_box[0] > x:
                global_bounding_box[0] = x
            if global_bounding_box[1] > y:
                global_bounding_box[1] = y
            if global_bounding_box[2] < x2:
                global_bounding_box[2] = x2
            if global_bounding_box[3] < y2:
                global_bounding_box[3] = y2
...
# directory of the stored images relative to utils.py
image_store_folder = "./app/images"
